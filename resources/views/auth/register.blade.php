<x-guest-layout>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full mx-4 bg-white shadow-lg rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <button type="button" onclick="togglePassword('password', 'password-eye-icon')"
                            ...
                            <svg id="password-eye-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M2.458 12C3.732 7.943 7.522 5 12 5c4.478 0 8.268 2.943 9.542 7-.274.936-.676 1.82-1.197 2.618M15.536 15.536A7.5 7.5 0 018.464 8.464m9.072 9.072a7.5 7.5 0 01-9.072-9.072" />
                            </svg>
                        </button>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <button type="button"
                            onclick="togglePassword('password_confirmation', 'confirm-password-eye-icon')"
                            class="absolute right-3 top-1/2 transform -translate-y-1/2">
                            <svg id="confirm-password-eye-icon" xmlns="http://www.w3.org/2000/svg"
    ...
    <script>
        function togglePassword(inputId, iconId) {
            ...
            if (passwordInput.type === 'password') {
                ...
                eyeIcon.innerHTML =
                    '<path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.522 5 12 5c4.478 0 8.268 2.943 9.542 7-.274.936-.676 1.82-1.197 2.618M15.536 15.536A7.5 7.5 0 018.464 8.464m9.072 9.072a7.5 7.5 0 01-9.072-9.072" />';
            } else {
