<x-guest-layout>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="mx-4 w-full bg-white shadow-lg rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mt-4">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <button type="button" onclick="togglePassword()" class="absolute right-3 flex items-center">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">{{ __("Don't have an account?") }}
                    <a wire:navigate href="{{ route('register') }}"
                        class="text-indigo-600 hover:underline">{{ __('Register') }}</a>
                </p>
            </div>
        </div>
    </div>
